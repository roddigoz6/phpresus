...
return [
    ...
    | utilizados por la clase de validador. Algunas de estas reglas tienen versiones
    ...
    */
    ...
    | especificar una línea de lenguaje personalizada para una regla de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para intercambiar nuestro marcador
    | de posición de atributo con algo más amigable para el lector, como "Dirección de correo electrónico"

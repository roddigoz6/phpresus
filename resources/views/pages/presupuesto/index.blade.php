...
<div class="container">
    <div class="row my-3 align-items-center">
        ...
        <div class="col text-end">
            <a href="{{ route('proyecto.index') }}" class="btn btn-light-primary">Ir a proyectos <i class="fas fa-plus-circle"></i></a>
        </div>
    </div>
            ...
            <table class="table table-light text-center table-hover rounded-table">
                ...
                <tbody>
                    @if ($presupuestos->isEmpty())
                        <tr>
                            <td colspan="7" class="text-center">No hay presupuestos creados.</td>
                        </tr>
                    @else
            ...
            <table class="table table-light text-center table-hover rounded-table">
                ...
                <tbody>
                    @if ($presupuestos->where('aceptado', 0)->isEmpty())
                        <tr>
                            <td colspan="7" class="text-center">No hay presupuestos rechazados o por aceptar.</td>
                        </tr>
                    @else
            ...
            <table class="table table-light text-center table-hover rounded-table">
                ...
                <tbody>
                    @if ($presupuestos->where('aceptado', 1)->isEmpty())
                        <tr>
                            <td colspan="7" class="text-center">No hay presupuestos aceptados.</td>
                        </tr>
                    @else
